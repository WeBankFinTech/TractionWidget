# validate
提供一个校验对象，具有常见的正则表达式和校验函数，配合fes-form的rule使用。
...
import { FForm, FFormItem, FInput } from '@fesjs/fes-design';
import { ref } from 'vue';
import { validate } from '@fesjs/traction-widget';
...
const formRule = ref({
    gpus: [
        ...
        { pattern: validate.REG.INTEGER, message: '必须为正整数', trigger: 'blur' },
        { validator: validate.VALIDATOR.INTW8, message: '必须小于99999999', trigger: 'blur' },
    ],
})
