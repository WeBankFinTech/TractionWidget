...
async function main () {
    ...
    const files = await glob([
        'packages/traction-widget/components/**/*.ts',
        'packages/traction-widget/components/**/*.tsx',
        'packages/traction-widget/components/**/*.vue',
        'packages/traction-widget/components/*.ts'
    ]);
    const sourceFiles = [];
    ...
    for (const sourceFile of sourceFiles) {
        ...
        for (const outputFile of emitOutput.getOutputFiles()) {
            const filePath = outputFile
                .getFilePath()
                .replace('/tractionWidget/types/packages/traction-widget/components/', '/tractionWidget/packages/traction-widget/es/components/');
