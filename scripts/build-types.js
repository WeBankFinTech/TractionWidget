...
async function main () {
    ...
    const files = await glob([
        'packages/bdp-design/components/**/*.ts',
        'packages/bdp-design/components/**/*.tsx',
        'packages/bdp-design/components/**/*.vue',
        'packages/bdp-design/components/*.ts'
    ]);
    const sourceFiles = [];
    ...
    for (const sourceFile of sourceFiles) {
        ...
        for (const outputFile of emitOutput.getOutputFiles()) {
            const filePath = outputFile
                .getFilePath()
                .replace('/bdp-web-components/types/packages/bdp-design/components/', '/bdp-web-components/packages/bdp-design/es/components/');
